...
form.btnCadastrar.addEventListener("clique", (evento) => {
...
function criarTrComBaseNoProduto(produto) {
  ...
  tdOpcoes.innerHTML = `<button onclick="editar(${produto.id})" class="btn btn-outline-info btn-sm" data-bs-toggle="modal"  data-bs-target="#cadastroProduto"
  >Editar</button>
